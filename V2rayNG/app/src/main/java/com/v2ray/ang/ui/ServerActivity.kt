...
class ServerActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val initialConfig = existingConfig ?: ProfileItem.create(createConfigType)
        setContent {
            AppTheme {
                ServerScreen(
                    guid = editGuid,
...
fun ServerScreen(
    ...
    val securityOptions = resources.getStringArray(R.array.securitys).toList()
    val ssSecurityOptions = resources.getStringArray(R.array.ss_securitys).toList()
    val flowOptions = resources.getStringArray(R.array.flows).toList()
    val networkOptions = resources.getStringArray(R.array.networks).toList()
    val tcpHeaderOptions = resources.getStringArray(R.array.header_type_tcp).toList()
    val kcpHeaderOptions = resources.getStringArray(R.array.header_type_kcp_and_quic).toList()
    val grpcModeOptions = resources.getStringArray(R.array.mode_type_grpc).toList()
    val xhttpModeOptions = resources.getStringArray(R.array.xhttp_mode).toList()
    val streamSecurityOptions = resources.getStringArray(R.array.streamsecurityxs).toList()
    val allowInsecureOptions = resources.getStringArray(R.array.allowinsecures).toList()
    val uTlsOptions = resources.getStringArray(R.array.streamsecurity_utls).toList()
    val alpnOptions = resources.getStringArray(R.array.streamsecurity_alpn).toList()
    val browserDialerOptions = resources.getStringArray(R.array.browser_dialer_mode_value).toList()

    var remarks by remember { mutableStateOf(initialConfig.remarks) }
    var address by remember { mutableStateOf(initialConfig.server ?: "") }
    var port by remember { mutableStateOf(initialConfig.serverPort ?: DEFAULT_PORT.toString()) }
    var password by remember { mutableStateOf(initialConfig.password ?: "") }
    var method by remember { mutableStateOf(initialConfig.method ?: "") }
    var flow by remember { mutableStateOf(initialConfig.flow ?: "") }
    var encryption by remember { mutableStateOf(initialConfig.method ?: "") }
    ...
    var preSharedKey by remember { mutableStateOf(initialConfig.preSharedKey ?: "") }
    var reserved by remember { mutableStateOf(initialConfig.reserved ?: "0,0,0") }
    var localAddress by remember { mutableStateOf(initialConfig.localAddress ?: WIREGUARD_LOCAL_ADDRESS_V4) }
    var mtu by remember { mutableStateOf(initialConfig.mtu?.toString() ?: WIREGUARD_LOCAL_MTU) }
    var obfsPassword by remember { mutableStateOf(initialConfig.obfsPassword ?: "") }
    var portHopping by remember { mutableStateOf(initialConfig.portHopping ?: "") }
    var portHoppingInterval by remember { mutableStateOf(initialConfig.portHoppingInterval ?: "") }
    var bandwidthDown by remember { mutableStateOf(initialConfig.bandwidthDown ?: "") }
    var bandwidthUp by remember { mutableStateOf(initialConfig.bandwidthUp ?: "") }
    var network by remember { mutableStateOf(initialConfig.network ?: NetworkType.TCP.type) }
    var headerType by remember { mutableStateOf(initialConfig.headerType ?: "none") }
    var host by remember { mutableStateOf(initialConfig.host ?: "") }
    var path by remember { mutableStateOf(initialConfig.path ?: "") }
    var seed by remember { mutableStateOf(initialConfig.seed ?: "") }
    var quicSecurity by remember { mutableStateOf(initialConfig.quicSecurity ?: "") }
    var quicKey by remember { mutableStateOf(initialConfig.quicKey ?: "") }
    var mode by remember { mutableStateOf(initialConfig.mode ?: "") }
    var serviceName by remember { mutableStateOf(initialConfig.serviceName ?: "") }
    var authority by remember { mutableStateOf(initialConfig.authority ?: "") }
    var xhttpMode by remember { mutableStateOf(initialConfig.xhttpMode ?: "") }
    var xhttpExtra by remember { mutableStateOf(initialConfig.xhttpExtra ?: "") }
    var finalMask by remember { mutableStateOf(initialConfig.finalMask ?: "") }
    var kcpMtu by remember { mutableStateOf(initialConfig.kcpMtu?.toString() ?: "") }
    var kcpTti by remember { mutableStateOf(initialConfig.kcpTti?.toString() ?: "") }
    var browserDialerMode by remember { mutableStateOf(initialConfig.browserDialerMode ?: browserDialerOptions.firstOrNull() ?: "Disable") }
    var streamSecurity by remember { mutableStateOf(initialConfig.security ?: "") }
    var sni by remember { mutableStateOf(initialConfig.sni ?: "") }
    var allowInsecureStr by remember {
        mutableStateOf(when {
    ...
    var publicKeyReality by remember { mutableStateOf(initialConfig.publicKey ?: "") }
    var shortId by remember { mutableStateOf(initialConfig.shortId ?: "") }
    var spiderX by remember { mutableStateOf(initialConfig.spiderX ?: "") }
    var mldsa65Verify by remember { mutableStateOf(initialConfig.mldsa65Verify ?: "") }
    var echConfigList by remember { mutableStateOf(initialConfig.echConfigList ?: "") }
    var verifyPeerCertByName by remember { mutableStateOf(initialConfig.verifyPeerCertByName ?: "") }
    var pinnedCA256 by remember { mutableStateOf(initialConfig.pinnedCA256 ?: "") }
    ...
    var isFetchingCert by remember { mutableStateOf(false) }
