...
object AppConfig {
    ...
    const val JSDELIVR_URL = "https://testingcf.jsdelivr.net/gh"
//    const val GITHUB_RAW_URL = "https://raw.githubusercontent.com"
//    const val GITHUB_DOWNLOAD_URL = "$GITHUB_URL/%s/releases/latest/download"
    const val GITHUB_DOWNLOAD_URL = "$JSDELIVR_URL/%s@release"
//    const val ANDROID_PACKAGE_NAME_LIST_URL = "$GITHUB_RAW_URL/2dust/androidpackagenamelist/master/proxy.txt"
    const val ANDROID_PACKAGE_NAME_LIST_URL = "$JSDELIVR_URL/2dust/androidpackagenamelist@master/proxy.txt"
...
//    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/v2rayNG/master/CR.md"
    const val APP_PRIVACY_POLICY = "$JSDELIVR_URL/2dust/v2rayNG@master/CR.md"
