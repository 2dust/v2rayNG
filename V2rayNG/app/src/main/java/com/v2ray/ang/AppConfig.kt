...
object AppConfig {
    ...
    const val PREF_ROUTING_PROFILE_IDS = "pref_routing_profile_ids"
    const val PREF_ROUTING_ACTIVE_PROFILE_ID = "pref_routing_active_profile_id"
    const val KEY_ROUTING_PROFILE_PREFIX = "routing_profile_"
    const val DEFAULT_ROUTING_PROFILE_NAME = "Default"
