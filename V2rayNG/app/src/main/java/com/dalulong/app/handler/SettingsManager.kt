...
import com.dalulong.app.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.dalulong.app.AppConfig.GEOIP_PRIVATE
import com.dalulong.app.AppConfig.GEOSITE_PRIVATE
import com.dalulong.app.AppConfig.TAG_DIRECT
import com.dalulong.app.AppConfig.VPN
...
import com.dalulong.app.enums.Language
import com.dalulong.app.enums.RoutingType
import com.dalulong.app.enums.VpnInterfaceAddressConfig
import com.dalulong.app.handler.MmkvManager.decodeAllServerList
import com.dalulong.app.handler.MmkvManager.decodeServerConfig
import com.dalulong.app.handler.MmkvManager.decodeSubsList
import com.dalulong.app.handler.MmkvManager.decodeSubscription
import com.dalulong.app.handler.MmkvManager.encodeSubscription
import com.dalulong.app.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    private fun ensureBuiltinSubscription() {
        val builtinUrl = "https://lzwyyds.ccwu.cc/sub?token=f45e2c2645731650cc5863376fc775f6"
        val existingSubs = MmkvManager.decodeSubscriptions()
        existingSubs.forEach {
            if (it.subscription.url == builtinUrl) {
                return
            }
        }
