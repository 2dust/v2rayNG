...
interface IShizukuTetheringService {
    ...
    int startRouting(boolean useHev, String profileName, String engineConfig, String assetPath, String xudpKey, String syncToken) = 6;
    int stopRouting() = 7;
    int notifyCoreStopping(String syncToken) = 9;
    int synchronizeRouting(String syncToken, boolean useHev, String profileName, String engineConfig) = 10;
